...
OUTPUT_PATH = WORK_DIR / "submission_11th_advanced_lightgbm_fold_te.csv"
DIAGNOSTIC_DIR = WORK_DIR / "outputs" / "11th_advanced_lightgbm_fold_te"
...
def train_and_predict(X, y, X_test, X_external, y_external, categorical_cols):
    ...
    print("=" * 60)
    print(f"Advanced LightGBM OOF AUC: {ensemble_auc:.6f}")
    print(
        "Fold AUC: "
