...
ADVANCED_LIGHTGBM_SUBMISSION_PATH = (
    DATA_DIR / "submission_13th_advanced_lightgbm_seed_ensemble.csv"
)
...
ADVANCED_LIGHTGBM_OOF_CANDIDATES = [
    ...
    DATA_DIR
    / "outputs"
    / "13th_advanced_lightgbm_seed_ensemble"
    / "oof_predictions.csv",
]
...
OUTPUT_TWO_MODEL_PATH = (
    DATA_DIR / "submission_13th_seed_lgbm_pytorch_probability_blend.csv"
)
OUTPUT_THREE_MODEL_PATH = (
    DATA_DIR / "submission_13th_seed_three_model_probability_blend.csv"
)
DIAGNOSTIC_DIR = DATA_DIR / "outputs" / "13th_seed_three_model_blend"
...
def main():
    ...
    print(
        "\nFine-grid best 13th + PyTorch probability blend: "
        f"13th={best_two_model['advanced_lightgbm_weight']:.2f}, "
