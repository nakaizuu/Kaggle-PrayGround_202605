...
OUTPUT_PATH = WORK_DIR / "submission_15th_gpu_pytorch_seed_ensemble.csv"
DIAGNOSTIC_DIR = WORK_DIR / "outputs" / "15th_gpu_pytorch_seed_ensemble"
...
# This is the longer GPU follow-up to the lightweight 9th experiment.
REQUIRE_CUDA = True
EPOCHS = 20
MIN_EPOCHS = 6
...
def main():
    ...
    if REQUIRE_CUDA and not torch.cuda.is_available():
        raise RuntimeError(
            ...
            "running the 15th GPU PyTorch experiment."
        )
    ...
    print("=" * 60)
    print(f"GPU PyTorch seed ensemble OOF AUC: {ensemble_auc:.6f}")
    print("\nSeed OOF AUC:")
    ...
    pd.DataFrame(
        {
            "metric": [
                "gpu_pytorch_seed_ensemble_oof_auc",
