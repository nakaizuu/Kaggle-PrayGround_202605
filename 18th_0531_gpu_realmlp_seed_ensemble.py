...
OUTPUT_PATH = WORK_DIR / "submission_18th_gpu_realmlp_seed_ensemble.csv"
DIAGNOSTIC_DIR = WORK_DIR / "outputs" / "18th_gpu_realmlp_seed_ensemble"
...
def main():
    ...
    if REQUIRE_CUDA and not torch.cuda.is_available():
        raise RuntimeError(
            ...
            "running the 18th RealMLP seed ensemble."
        )
    ...
    print("=" * 60)
    print(f"GPU RealMLP seed ensemble OOF AUC: {ensemble_auc:.6f}")
    print("\nSeed OOF AUC:")
    ...
    pd.DataFrame(
        {
            "metric": [
                "gpu_realmlp_seed_ensemble_oof_auc",
