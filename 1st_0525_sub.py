...
OUTPUT_PATH = DATA_DIR / "submission_lightgbm.csv"
...
# The public notebooks for this competition seem to use probabilities.
# Keep this True for AUC/log-loss style submissions.
